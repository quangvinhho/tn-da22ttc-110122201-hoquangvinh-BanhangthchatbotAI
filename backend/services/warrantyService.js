...
async function createWarrantiesForOrder(orderId) {
    try {
        ...
        for (const item of items) {
            ...
            // Xác định thời hạn bảo hành mặc định dựa trên loại sản phẩm (nếu có thông tin) hoặc mặc định 12 tháng
            let warrantyMonths = 12; // Mặc định 12 tháng bảo hành cho điện thoại/laptop
